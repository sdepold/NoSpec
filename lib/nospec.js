...
var methods = {
  ...
  load: function(file) {
    ...
    try { 
      ...
      fileContent = fs.readFileSync(file + ".js")
    }
    eval("with(wrappers){\n" + fileContent + "\n}")
  ...
  printResults: function(){
    sys.puts("Total specs: " + this.specs.registered.length + ", Success: " + (this.specs.succeeded.length) + ", Failed: " + this.specs.failed.length)
