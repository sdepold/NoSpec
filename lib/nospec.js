...
var methods = {
  ...
  load: function(specLocation) {
    if(isDirectory(specLocation)) {
      this.loadDir(specLocation)
    } else if(isFile(specLocation.endsWith(".js") ? specLocation : specLocation + ".js")) {
      this.loadFile(specLocation.endsWith(".js") ? specLocation : specLocation + ".js")
    } else {
